...
<html lang="en">
    <head>
        ...
        <link href="{{url('//maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css')}}" rel="stylesheet" id="bootstrap-css">
<script src="{{url('//maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js')}}"></script>
...
.footer-area{
   background: url({{ asset('images/footer.png')}}) repeat-x;
    padding: 10px 0 0px;
    color: #fff;
    font-size: 12px;
           		...
           		<div class="container">
					<div class="float-right">
						<ul class="list header_social">
							...
							<li><a href="{{ url('/create')}}"><i class="fa fa-user"></i> Login </a></li>
						</ul>
					</div>
            ...
            <div class="main_menu">
            	<nav class="navbar navbar-expand-lg navbar-light">
					<div class="container">
						...
						<a class="navbar-brand logo_h" href="index.php"><img src="{{ asset('img/margdarshak-logo.png') }}" alt=""></a>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-6">
                        ...
                        <img src="{{ asset('img/parents.png') }}" class="img-fluid">
    ...
    <div id="carouselExample" class="carousel slide" data-ride="carousel" data-interval="9000">
        <div class="carousel-inner row w-100 mx-auto" role="listbox">
            <div class="carousel-item col-md-3  active">
                <div class="team_item">
                            <div class="team_img">
                                <img class="rounded-circle" src="{{ asset('img/team/team-1.jpg') }}" alt="">
                                <div class="hover">
        	...
        	<div class="container">
                ...
                <div class="row" style="text-align: center;">
                    <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
                        <img src="{{ asset('img/margdarshak-talent.png') }}" class="team_img">
                        <div class="one">
                            <p style="color:#fff;">
                                hello doly
                            </p>
                     ...
                     <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
                        <img src="{{ asset('img/margdarshak-education.png') }}" class="team_img">
                        <div class="one">
                            <p style="color:#fff;">
                                hello doly
                            </p>
                     ...
                     <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
                        <img src="{{ asset('img/margdarshak-career.png') }}" class="team_img">
                        <div class="one">
                            <p style="color:#fff;">
                                hello doly
                            </p>
                     ...
                     <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
                       <img src="{{ asset('img/margdarshak-study.png') }}" class="team_img">
                        <div class="one">
                            <p style="color:#fff;">
                                hello doly
                            </p>
                     ...
                     <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
                        <img src="{{ asset('img/margdarshak-apptitude.png') }}" class="team_img">
                        <div class="one">
                            <p style="color:#fff;">
                                hello doly
                            </p>
                     ...
                     <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
                        <img src="{{ asset('img/margdarshak-index.png') }}" class="team_img">
                        <div class="one">
                            <p style="color:#fff;">
                                hello doly
                            </p>
        		...
        		<div class="row latest_blog_inner">
        			<div class="col-lg-3 col-md-6">
        				<div class="l_blog_item">
        					<img class="img-fluid" src="{{ asset('img/latest-blog/l-blog-1.jpg') }}" alt="">
        			...
        			<div class="col-lg-3 col-md-6">
        				<div class="l_blog_item">
        					<img class="img-fluid" src="{{ asset('img/latest-blog/l-blog-2.jpg') }}" alt="">
        					<a class="date" href="#">25 October, 2018  |  By Mark Wiens</a>
        					<a href="single-blog.html"><h4>Addiction When Gambling Becomes A Problem</h4></a>
        					<p>Computers have become ubiquitous in almost every facet of our lives. At work, desk jockeys spend hours in front of their desktops, while delivery</p>
        				</div>
        			...
        			<div class="col-lg-3 col-md-6">
        				<div class="l_blog_item">
        					<img class="img-fluid" src="{{ asset('img/latest-blog/l-blog-3.jpg')}}" alt="">
        					<a class="date" href="#">25 October, 2018  |  By Mark Wiens</a>
        					<a href="single-blog.html"><h4>Addiction When Gambling Becomes A Problem</h4></a>
        					<p>Computers have become ubiquitous in almost every facet of our lives. At work, desk jockeys spend hours in front of their desktops, while delivery</p>
        				</div>
        			...
        			<div class="col-lg-3 col-md-6">
        				<div class="l_blog_item">
        					<img class="img-fluid" src="{{ asset('img/latest-blog/l-blog-4.jpg')}}" alt="">
        					<a class="date" href="#">25 October, 2018  |  By Mark Wiens</a>
        					<a href="single-blog.html"><h4>Addiction When Gambling Becomes A Problem</h4></a>
        					<p>Computers have become ubiquitous in almost every facet of our lives. At work, desk jockeys spend hours in front of their desktops, while delivery</p>
        				</div>
...
<li>
<a href="#"><img src="{{ asset('img/school1.jpg')}}" alt="description"></a>
</li>
<li>
<a href="#"><img src="{{ asset('img/school2.jpg')}}" alt="description"></a>
</li>
<li>
<a href="#"><img src="{{ asset('img/school3.jpg')}}" alt="description"></a>
</li>
<li>
<a href="#"><img src="{{ asset('img/school4.jpg')}}" alt="description"></a>
</li>
<li>
<a href="#"><img src="{{ asset('img/school5.jpg')}}" alt="description"></a>
</li>
<li>
<a href="#"><img src="{{ asset('img/school6.jpg')}}" alt="description"></a>
</li>
<li>
<a href="#"><img src="{{ asset('img/school7.jpg')}}" alt="description"></a>
</li>
<li>
<a href="#"><img src="{{ asset('img/school8.jpg')}}" alt="description"></a>
</li>
<li>
<a href="#"><img src="{{ asset('img/school9.jpg')}}" alt="description"></a>
</li>
<li>
<a href="#"><img src="{{ asset('img/school10.jpg')}}" alt="description"></a>
</li>
<li>
<a href="#"><img src="{{ asset('img/school11.jpg')}}" alt="description"></a>
</li>
<li>
<a href="#"><img src="{{ asset('img/school12.jpg')}}" alt="description"></a>
</li>
<li>
<a href="#"><img src="{{ asset('img/school13.jpg')}}" alt="description"></a>
</li>
<li>
<a href="#"><img src="{{ asset('img/school14.jpg')}}" alt="description"></a>
</li>
<li>
<a href="#"><img src="{{ asset('img/school15.jpg')}}" alt="description"></a>
</li>
<li>
<a href="#"><img src="{{ asset('img/school16.jpg')}}" alt="description"></a>
</li>
<li>
<a href="#"><img src="{{ asset('img/school14.jpg')}}" alt="description"></a>
</li>
<li>
<a href="#"><img src="{{ asset('img/school18.jpg')}}" alt="description"></a>
</li>
<li>
<a href="#"><img src="{{ asset('img/school19.jpg')}}" alt="description"></a>
</li>
</ul>
</div>
</div>
